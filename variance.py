...
file_path = "Active and Inactive Items Report.xlsx"  # 👈 change to your file path
if file_path.endswith(".csv"):
    df = pd.read_csv(file_path)
else:
    df = pd.read_excel(file_path)

# Show actual column names from file
st.write("📋 Columns detected in your file:", list(df.columns))

# --- Standardize Column Names ---
# Adjust mappings based on what your file shows in the output above
df.rename(columns={
    "ItemCode": "Item Code",
    "Item_Name": "Item Name",
    "Item Name ": "Item Name",
    ...
    "Selling Price": "Sel Price",
    "SelPrice": "Sel Price",
    "Margin %": "Margin",
    "Markup %": "Markup",
    "Quantity Sold": "Qty Sold",
    "QtySold": "Qty Sold",
    "Stock Qty": "Stock",
    "Stock ": "Stock"
}, inplace=True)
...
required_cols = ["Item Code", "Item Name", "Cost Price", "Sel Price", "Margin", "Markup", "Qty Sold", "Stock"]
